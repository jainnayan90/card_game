...
5) to play a turn
    ...
    - Here id id the id of the game on which players are playing. You will get the id of the game in response  when a third player joins the game. player_id is the id of the player. card_val id the card_val parameter received from step 4.

8) After 8 rounds are finished winners are declared and the game is reinitialised with the same game id.
